...
public class view_package extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = sh.getString("url","") + "/and_customer_view_package";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                package_id=new String[js.length()];
                                ...
                                for(int i=0;i<js.length();i++)
                                {
                                    ...
                                    package_id[i]=u.getString("package_id");
...
//                                }
                                ...
                                li.setAdapter(new custom_view_package(getApplicationContext(),package_id,type,name,amount));
