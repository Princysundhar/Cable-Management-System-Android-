...
public class view_previous_history extends AppCompatActivity {
    ListView li;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_previous_history);
        li = findViewById(R.id.listview);

        sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        sh.getString("ipaddress","");
        url = sh.getString("url","") + "/and_view_previous_history";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                subcription_details=new String[js.length()];
                                ...
                                for(int i=0;i<js.length();i++)
                                {
                                    ...
                                    subcription_details[i]=u.getString("subcription_details");
...
//                                }
                                ...
                                li.setAdapter(new custom_view_previous_history(getApplicationContext(),hid,date,payment_date,payment_status,subcription_details,amount));
