...
public class view_customer_report extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = sh.getString("url","") + "/and_customer_report";
...
//                                }
                                ...
                                li.setAdapter(new custom_view_customer_report(getApplicationContext(),subcription_id,type,amount,status,date,expiry_date,customer_info));
