                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                offer_id=new String[js.length()];
                                type=new String[js.length()];
                                title=new String[js.length()];
                                offer=new String[js.length()];
                                ...
                                for(int i=0;i<js.length();i++)
                                {
                                    ...
                                    offer_id[i]=u.getString("offer_id");
                                    type[i]=u.getString("type");
                                    title[i]=u.getString("title");
                                    offer[i]=u.getString("offer");
...
//                                }
                                ...
                                li.setAdapter(new custom_view_offer(getApplicationContext(),offer_id,type,title,offer));
